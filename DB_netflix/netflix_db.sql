...
ALTER TABLE tarjeta_credito ADD constraint FOREIGN KEY (fk_id_plan)REFERENCES plan(id_plan);

-- tarjeta_debito definen las  llaves primaria y foranea de la tabla
ALTER TABLE tarjeta_debito ADD primary key (id_tarjeta_d);
ALTER TABLE tarjeta_debito ADD constraint FOREIGN KEY (fk_id_plan)REFERENCES plan(id_plan);

-- efectivo definen las  llaves primaria y foranea de la tabla
ALTER TABLE efectivo ADD primary key (id_efectivo);
ALTER TABLE efectivo ADD constraint FOREIGN KEY (fk_id_plan)REFERENCES plan(id_plan);

-- tarjeta_regalo      definen las  llaves primaria y foranea de la tabla
ALTER TABLE tarjeta_regalo ADD primary key (id_tregalo);
ALTER TABLE tarjeta_regalo ADD constraint FOREIGN KEY (fk_id_plan)REFERENCES plan(id_plan);
