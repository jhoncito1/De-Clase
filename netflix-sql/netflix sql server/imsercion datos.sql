...
insert into perfil
values 
(1, 'lobo30',1, null, '1063598610', '02' ),
(2, 'amigos', 0, null, '1063598611', '02' ),
(3, 'los de casa', 0, null, '1063114-ES','02' );
...
(02,'TD', 'tarjeta debito'),
(03,'TR', 'targeta regalo'),
(04,'EF', 'efectivo');

insert into factura
values
(0001, 30000, '2019-08-31 16:19:59', 01, 122, '1032431981', '02'),
(0002, 30000, '2018-08-31 16:19:59', 01, 122, '1066587221', '02'),
(0003, 30000, '2019-08-31 16:19:59', 04, 122, '1063596-AR', '03'),
(0004, 30000, '2019-08-31 16:19:59', 01, 122, '1063598_CO', '04'),
(0005, 30000, '2019-08-31 16:19:59', 03, 122, '106357811', '01'),

(0006, 40000, '2019-08-31 16:19:59', 01, 121, 'tyfdvhjjj', '01'),
(0007, 40000, '2019-08-31 16:19:59', 02, 121, '106387711', '02'),
(0008, 40000, '2019-08-31 16:19:59', 02, 121, '1056842', '03'),
(0009, 40000, '2019-08-31 16:19:59', 02, 121, '1063114-ES', '02'),

(0010, 20000, '2019-08-31 16:19:59', 01, 123, '1032431981', '02'),
(0011, 20000, '2019-08-31 16:19:59', 01, 123, '1063598611', '02'),
(0012, 20000, '2019-08-31 16:19:59', 04, 123, '1063598610', '02'),

(0013, 00000, '2019-08-31 16:19:59', 04, 125, '1063114-ES', '02'),

(0014, 20000, '2019-08-31 16:19:59', 03, 124, '1063598611', '02'),
(0015, 20000, '2019-08-31 16:19:59', 04, 124, '1063598_CO', '04');
...
values 
('3001', 'inicia', 'adios al final de su destino','201'),
('3002', 'su final' , ' muerte subita', '201' ),
('3003', 'su secreto', 'al amor y su precio', '201' ),
('3004', 'trascurso', ' vendida y peligrosa ', '202' ),
('3005', 'observalo', 'en la calle sola', '202');

insert into  capitulos 
values 
('401',11,'el juego', '00:40:10','el despertar del destino','301'),
('402',12,'trama sin perdida', '00:43:10','entra en apuros mientras es descubierto','302'),
('403',13,'sus brazos','00:32:10','sin tener miedo','301'),
('404',14,'entre el y su principio','00:29:20','lo quiere todo pero no es necesario','301'),
('405',15,'final a su cominezo','01:09:20','pierde todo en un abrir y cerrar de ojos','301'),
('406',16,'llora por todo','01:07:00','su drama','302'),
('407',17,'se vuelve fuerte','01:09:00','un asco','302'),
('408',18,'hace lo posible','01:11:00','se enamora perdidamente','302'),
('409',19,'lo quiere todo','01:33:00','disfruta aun puedes','302'),
('410',20,'es claro en todo', '01:34:00','ama y moriras feliz','302');
