...
on us.fk_id_documento = tp.id_documento where tp.siglas = 'CC';

-- === 8. Número de usuarios que tienen CC
select count(*) from usuario where fk_id_documento = '02';


--  === 9. Número de usuarios que tienen CC o CE

select count(*) from usuario where fk_id_documento = '02' or fk_id_documento = '03';
